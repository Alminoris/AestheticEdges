...
public class CurtainRodBlock extends YAxisRotatedBlock
{
    ...
    public static final EnumProperty<CurtainRodBlock.Color> COLOR = EnumProperty.of("color", CurtainRodBlock.Color.class);

    public static final EnumProperty<CurtainRodBlock.Variant> VARIANT = EnumProperty.of("variant", CurtainRodBlock.Variant.class);
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit)
    {
        ...
        if (stack.isIn(ModTags.Items.CURTAINS) && !currentDressed)
        {
            if (!world.isClient)
            {
                ...
                String colorName = Registries.ITEM.getId(stack.getItem()).getPath().replace("curtain_", "");
        ...
        if (stack.getItem() == ModItems.CURTAIN_REMOVER)
        {
            if (!world.isClient)
            {
                ...
                Item item = Registries.ITEM.get(Identifier.of(AestheticEdges.MOD_ID, "curtain_"+colorName));
